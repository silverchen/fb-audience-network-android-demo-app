...
public class FinestWebView {
  ...
  public static class Builder implements Serializable {
    ...
    protected Boolean webViewSavePassword;
    ...
    protected WebSettings.RenderPriority webViewRenderPriority;
    protected Integer webViewMixedContentMode;
    protected Boolean webViewOffscreenPreRaster;
    protected Boolean webViewEnableSmoothTransition;
    ...
    public Builder webViewSavePassword(boolean webViewSavePassword) {
      this.webViewSavePassword = webViewSavePassword;
      return this;
    }
    ...
    public Builder webViewRenderPriority(WebSettings.RenderPriority webViewRenderPriority) {
      this.webViewRenderPriority = webViewRenderPriority;
      return this;
    }
    ...
    public Builder webViewEnableSmoothTransition(boolean webViewEnableSmoothTransition) {
      this.webViewEnableSmoothTransition = webViewEnableSmoothTransition;
      return this;
    }
