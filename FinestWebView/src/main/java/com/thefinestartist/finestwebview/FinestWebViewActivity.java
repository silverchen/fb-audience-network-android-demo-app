...
public class FinestWebViewActivity extends AppCompatActivity
  ...
  protected void initializeOptions() {
    ...
    webViewSavePassword = builder.webViewSavePassword;
    ...
    webViewEnableSmoothTransition = builder.webViewEnableSmoothTransition;
  ...
  @SuppressLint("SetJavaScriptEnabled") protected void initializeViews() {
    ...
    { // WebView
      ...
      if (webViewSavePassword != null) settings.setSavePassword(webViewSavePassword);
      ...
      if (webViewRenderPriority != null) settings.setRenderPriority(webViewRenderPriority);
      ...
      if (webViewEnableSmoothTransition != null) settings.setEnableSmoothTransition(webViewEnableSmoothTransition);
